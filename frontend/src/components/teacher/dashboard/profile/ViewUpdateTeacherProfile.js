           ...
           <form onSubmit={updateTeacherAcc} className='flex flex-col space-y-6 divide-y'>
                    ...
                    <div className="w-[70%] pl-6">
                        ...
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            {teacherDetails?.middle_name && (
                                <div>
                                    <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Middle name</h3>
                                    <div 
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    >
                                        {teacherDetails?.middle_name}    
                            ...
                            <div>
                                <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last name</h3>
                                <div 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                            ...
                            <div>
                                <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birth date</h3>
                                <div 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                        ...
                        <div>
                            <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Home address</h3>
                            <div 
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                ...
                <div className="flex flex-row pt-6">
                    ...
                    <div className="w-[70%] pl-6">
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zoom Link</h3>
                                <div 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                            ...
                            <div>
                                <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zoom ID</h3>
                                <div 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                            ...
                            <div>
                                <h3 className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zoom password</h3>
                                <div 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
