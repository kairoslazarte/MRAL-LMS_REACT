        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-white h-screen">
            ...
            {/* Logo */}
                <div className="mb-8 lg:mb-20">
                    ...
                    <img className='h-14 mr-2' src="/static/images/mral-logo-sm.png" />
                <span className="text-lg sm:text-xl font-semibold text-gray-800">Mt. Rushmore Academy of Laguna</span>
                    </div>
                </div>
            ...
            <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-400 to-blue-600 p-8 lg:p-12 flex flex-col items-center justify-center relative h-full">
                {/* Sign Up Content */}
                <div className="text-center text-white py-8 lg:py-0">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">Mt. Rushmore Academy of Laguna</h2>
