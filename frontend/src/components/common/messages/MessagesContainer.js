	...
	return (
        <div className='md:min-w-[450px] flex flex-col'>
            {!selectedConversation ? (
                ...
                <div className="bg-red-200 h-[30rem] sm:h-[40rem] flex flex-col rounded-md shadow bg-opacity-20">
                    {/* Header */}
                    <div className='bg-sky-500 rounded-t-md px-4 py-2 mb-2 bg-opacity-60'>
