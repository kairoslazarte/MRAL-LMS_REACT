        ...
        <header className="w-full sticky top-0 bg-white border-b border-gray-200 z-20">
            <div className="pr-4 xl:pr-8 flex items-center py-2">
                ...
                <div className="ml-auto flex items-center space-x-4">
                    <h3 className="text-blue-700 font-medium justify-end flex xl:text-base text-sm">
                    ...
                    <div className="relative">
                        ...
                        {openUserDropdown && (
                             <div className="absolute bg-white w-[200px] right-0 shadow-xl rounded-b-lg">
                                <button
                                    className="group flex items-center justify-center px-2 py-2 text-sm font-medium rounded-md text-blue-700 hover:bg-blue-700 hover:text-white w-full"
